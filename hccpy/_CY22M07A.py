...
def _adult(cc_lst):
    ...
    if (
        z["SEVERE_V3_X_HHS_HCC006"]
        + z["SEVERE_V3_X_HHS_HCC008"]
        + z["SEVERE_V3_X_HHS_HCC009"]
        + z["SEVERE_V3_X_HHS_HCC010"]
        + z["SEVERE_V3_X_HHS_HCC115"]
        + z["SEVERE_V3_X_HHS_HCC135"]
        + z["SEVERE_V3_X_HHS_HCC145"]
        + z["SEVERE_V3_X_G06A"]
        + z["SEVERE_V3_X_G08"]
    ):
        x["INT_GROUP_H"] = 1
    ...
    x["RXC_04_X_HCC184_183_187_188"] = x["RXC_04"] * (
        x["HHS_HCC184"] + x["HHS_HCC183"] + x["HHS_HCC187"] + x["HHS_HCC188"]
    )
    x["RXC_05_X_HCC048_041"] = x["RXC_05"] * (x["HHS_HCC048"] + x["HHS_HCC041"])
    x["RXC_06_X_HCC018_019_020_021"] = x["RXC_06"] * (
        x["HHS_HCC018"] + x["HHS_HCC019"] + x["HHS_HCC020"] + x["HHS_HCC021"]
    )
    x["RXC_07_X_HCC018_019_020_021"] = x["RXC_07"] * (
        x["HHS_HCC018"] + x["HHS_HCC019"] + x["HHS_HCC020"] + x["HHS_HCC021"]
    )
    x["RXC_08_X_HCC118"] = x["RXC_08"] * x["HHS_HCC118"]
    x["RXC_09_X_HCC056_057_AND_048_041"] = (
        x["RXC_09"]
    ...
    x["RXC_09_X_HCC048_041"] = x["RXC_09"] * (x["HHS_HCC048"] + x["HHS_HCC041"])
    x["RXC_10_X_HCC159_158"] = x["RXC_10"] * (x["HHS_HCC159"] + x["HHS_HCC158"])
...
def _infant(cc_lst, age):
    ...
    if age >= 1:
        ...
        z["IHCC_Extremely_Immature"] = (
            x["HHS_HCC242"] + x["HHS_HCC243"] + x["HHS_HCC244"]
        )
    ...
    x["EXTREMELY_IMMATURE_X_SEVERITY5"] = (
        z["IHCC_Severity5"] * z["IHCC_Extremely_Immature"]
    )
    x["IMMATURE_X_SEVERITY5"] = z["IHCC_Severity5"] * z["IHCC_Immature"]
    x["PREMATURE_MULTIPLES_X_SEVERITY5"] = (
        z["IHCC_Severity5"] * z["IHCC_Premature_Multiples"]
    )
    x["TERM_X_SEVERITY5"] = z["IHCC_Severity5"] * z["IHCC_Term"]
    x["AGE1_X_SEVERITY5"] = z["IHCC_Severity5"] * z["IHCC_Age1"]
    x["EXTREMELY_IMMATURE_X_SEVERITY4"] = (
        z["IHCC_Severity4"] * z["IHCC_Extremely_Immature"]
    )
    x["IMMATURE_X_SEVERITY4"] = z["IHCC_Severity4"] * z["IHCC_Immature"]
    x["PREMATURE_MULTIPLES_X_SEVERITY4"] = (
        z["IHCC_Severity4"] * z["IHCC_Premature_Multiples"]
    )
    x["TERM_X_SEVERITY4"] = z["IHCC_Severity4"] * z["IHCC_Term"]
    x["AGE1_X_SEVERITY4"] = z["IHCC_Severity4"] * z["IHCC_Age1"]
    x["EXTREMELY_IMMATURE_X_SEVERITY3"] = (
        z["IHCC_Severity3"] * z["IHCC_Extremely_Immature"]
    )
    x["IMMATURE_X_SEVERITY3"] = z["IHCC_Severity3"] * z["IHCC_Immature"]
    x["PREMATURE_MULTIPLES_X_SEVERITY3"] = (
        z["IHCC_Severity3"] * z["IHCC_Premature_Multiples"]
    )
    x["TERM_X_SEVERITY3"] = z["IHCC_Severity3"] * z["IHCC_Term"]
    x["AGE1_X_SEVERITY3"] = z["IHCC_Severity3"] * z["IHCC_Age1"]
    x["EXTREMELY_IMMATURE_X_SEVERITY2"] = (
        z["IHCC_Severity2"] * z["IHCC_Extremely_Immature"]
    )
    x["IMMATURE_X_SEVERITY2"] = z["IHCC_Severity2"] * z["IHCC_Immature"]
    x["PREMATURE_MULTIPLES_X_SEVERITY2"] = (
        z["IHCC_Severity2"] * z["IHCC_Premature_Multiples"]
    )
    x["TERM_X_SEVERITY2"] = z["IHCC_Severity2"] * z["IHCC_Term"]
    x["AGE1_X_SEVERITY2"] = z["IHCC_Severity2"] * z["IHCC_Age1"]
    x["EXTREMELY_IMMATURE_X_SEVERITY1"] = (
        z["IHCC_Severity1"] * z["IHCC_Extremely_Immature"]
    )
    x["IMMATURE_X_SEVERITY1"] = z["IHCC_Severity1"] * z["IHCC_Immature"]
    x["PREMATURE_MULTIPLES_X_SEVERITY1"] = (
        z["IHCC_Severity1"] * z["IHCC_Premature_Multiples"]
    )
